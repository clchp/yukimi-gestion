...
import { auditLogSchema, dashboardSchema, notificationListSchema, reportDataSchema } from '@yukimi/shared';
...
test('report and audit contracts accept empty datasets', () => {
  const report = reportDataSchema.parse({
    ...
    period: { startDate: '2026-07-01', endDate: '2026-07-30', previousStartDate: '2026-06-01', previousEndDate: '2026-06-30' },
    warehouses: [],
    summary: { netSales: 0, collected: 0, estimatedCost: 0, estimatedProfit: 0, averageTicket: 0, outstandingBalance: 0, salesCount: 0, unitsSold: 0, previousNetSales: 0, salesChangePercent: null },
    daily: [], topProducts: [], categories: [], topClients: [],
    inventory: { availableUnits: 0, reservedUnits: 0, lowStockVariants: 0, valuationPen: 0 },
    lowStock: [], channels: [],
  });
  const audit = auditLogSchema.parse({ items: [], page: 1, pageSize: 25, total: 0, summary: { last30Days: 0, sensitiveActions: 0, actors: [] } });
