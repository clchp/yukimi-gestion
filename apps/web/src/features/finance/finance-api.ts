...
export function createFinanceCategory(
  ...
  return apiRequest<{ id: string; code: string; name: string; reused: boolean }>(
    '/finance/categories',
...
export function createManualFinanceTransaction(
  ...
  return apiRequest<FinanceMutationResult>('/finance/transactions', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
}
export function createFinanceTransfer(
  input: CreateFinanceTransferInput,
  key: string,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>('/finance/transfers', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
}
export function reverseFinanceTransaction(
  id: string,
  reason: string,
  key: string,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>(`/finance/transactions/${id}/reverse`, {
    method: 'POST',
    headers: { 'idempotency-key': key },
...
export function createObligation(
  ...
  return apiRequest<FinanceMutationResult>('/finance/obligations', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
...
export function payObligation(
  ...
  return apiRequest<FinanceMutationResult>(`/finance/obligations/${id}/pay`, {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
}
export function createReceivedLoan(
  input: CreateReceivedLoanInput,
  key: string,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>('/finance/loans', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
...
export function payLoanInstallment(
  ...
  return apiRequest<FinanceMutationResult>(`/finance/loan-installments/${id}/pay`, {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
...
export function createCashClosure(
  ...
  return apiRequest<CashClosureResult>('/finance/cash-closures', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
}
export function getBankReconciliation(filters: {
...
export function importBankStatement(
  ...
  return apiRequest<BankImportResult>('/finance/bank-statements/import', {
    method: 'POST',
    headers: { 'idempotency-key': key },
    body: JSON.stringify(input),
  });
}
export function confirmBankReconciliation(
  rowId: string,
  input: ConfirmBankReconciliationInput,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>(`/finance/bank-rows/${rowId}/reconcile`, {
    method: 'POST',
    body: JSON.stringify(input),
  });
}
export function dismissBankCandidate(
  candidateId: string,
  reason: string,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>(`/finance/bank-candidates/${candidateId}/dismiss`, {
    method: 'POST',
    body: JSON.stringify({ reason }),
  });
}
export function ignoreBankRow(rowId: string, reason: string): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>(`/finance/bank-rows/${rowId}/ignore`, {
    method: 'POST',
    body: JSON.stringify({ reason }),
  });
}
export function reverseBankReconciliation(
  id: string,
  reason: string,
): Promise<FinanceMutationResult> {
  return apiRequest<FinanceMutationResult>(`/finance/bank-reconciliations/${id}/reverse`, {
    method: 'POST',
    body: JSON.stringify({ reason }),
  });
}

export function registerFinanceAttachment(
  ...
  return apiRequest<{ id: string }>(`/finance/transactions/${transactionId}/attachments`, {
    method: 'POST',
    body: JSON.stringify(input),
  });
}

export function updateFinanceCategory(categoryId: string, input: UpdateFinanceCategoryInput) {
  return apiRequest<{
    id: string;
    code: string;
    name: string;
