-- Yukimi Gestión
-- Migración 042: la cancelación general registra eventos solo para cajas modificadas.
...
begin
  ...
  loop
    if not exists (
      ...
      raise exception 'La caja % está en % y no admite cancelación. Resuelve esa caja antes de cancelar la importación.',
