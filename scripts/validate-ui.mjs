...
requireText(responsive, '.mobile-scroll-panel .responsive-table-wrap', 'Las tablas ERP sin tarjetas no tienen alternativa móvil.');
requireText(responsive, '.import-box-detail .responsive-table-wrap', 'Las líneas de importación no tienen desplazamiento móvil.');
...
requireText(importDetail, 'import-box-detail', 'La importación no conserva acceso a sus líneas en móvil.');
...
requireText(reports, 'mobile-scroll-panel', 'Reportes pierde su rentabilidad por producto en móvil.');
rejectText(saleDetail, 'window.prompt', 'El flujo sensible de liberación aún usa prompts del navegador.');
